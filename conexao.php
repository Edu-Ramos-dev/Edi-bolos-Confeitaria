...
$hostname_conn_bd_edibolos = "localhost";
   ...
   $conn_bd_edibolos = mysqli_connect($hostname_conn_bd_edibolos, $username_conn_bd_edibolos, $password_conn_bd_edibolos, $database_conn_bd_edibolos) or trigger_error(mysqli_connect_errno());
